...
function addRule(source: string, name: string, ruleBody: string): void {
  ...
  catalog.rules[name] = { description: 'x', preference: false, requires: [], path: `rules/${name}.md`, profiles: ['demo'] }
...
function ctxWith(now: () => string = () => '2026-07-17T00:00:00Z', overrides: Partial<IfitContext> = {}): IfitContext {
  return {
    download: async () => ({}),
